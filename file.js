...
class Heart extends mojs.CustomShape {// legat de inima animata <33
  getShape() {
...
const crtLoveTl = () => {
  ...
  const opts = { duration: move, opacity: 1 };
  const delta = 150;
